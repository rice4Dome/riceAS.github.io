...
* **Key message**  
    ...
    + To determine if there exists, a correlation between OsCKX2 levels and yield under salinity stress condition, we assessed the growth, physiology and grain yield of OsCKX2-knockdown plants vis-ÃÂÃÂÃÂÃÂ -vis the wild-type
